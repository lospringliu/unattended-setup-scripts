...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/lospringliu/unattended-setup-scripts/master/UpdateAndSysprep.ps1" -OutFile "$ENV:SYSTEMROOT\Temp\UpdateAndSysprep.ps1"
Invoke-WebRequest -uri "https://raw.githubusercontent.com/lospringliu/unattended-setup-scripts/master/Unattend.xml" -OutFile "$ENV:SYSTEMROOT\Temp\Unattend.xml"
